...
bool LIBTCGT_API LibTCGT_get_env_register_from_offset(uint32_t offset, unsigned * reg, unsigned * off)
{
	...
	GET_REG_OFFSET(CPUX86State, regs[0], X86::Reg::eax)
		...
		// cr
		GET_REG_OFFSET(CPUX86State, cr[0], X64::Reg::cr0)
		GET_REG_OFFSET(CPUX86State, cr[1], X64::Reg::cr1)
		GET_REG_OFFSET(CPUX86State, cr[2], X64::Reg::cr2)
		GET_REG_OFFSET(CPUX86State, cr[3], X64::Reg::cr3)
		GET_REG_OFFSET(CPUX86State, cr[4], X64::Reg::cr4)
		GET_REG_OFFSET(CPUX86State, xcr0, X64::Reg::xcr0)
		// dr
		GET_REG_OFFSET(CPUX86State, dr[0], X64::Reg::dr0)
		GET_REG_OFFSET(CPUX86State, dr[1], X64::Reg::dr1)
		GET_REG_OFFSET(CPUX86State, dr[2], X64::Reg::dr2)
		GET_REG_OFFSET(CPUX86State, dr[3], X64::Reg::dr3)
		GET_REG_OFFSET(CPUX86State, dr[4], X64::Reg::dr4)
		GET_REG_OFFSET(CPUX86State, dr[5], X64::Reg::dr5)
		GET_REG_OFFSET(CPUX86State, dr[6], X64::Reg::dr6)
		GET_REG_OFFSET(CPUX86State, dr[7], X64::Reg::dr7)
		// flag
